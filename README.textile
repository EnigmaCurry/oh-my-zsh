h2. EnigmaCurry's oh-my-zshell fork

This is EnigmaCurry's fork of robbyrussel's "oh-my-zsh":http://github.com/robbyrussell/oh-my-zsh
...
@wget http://github.com/enigmacurry/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/enigmacurry/oh-my-zsh.git ~/.oh-my-zsh@
